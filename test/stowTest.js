...
describe('STOW Tests', () => {
  ...
  it('wado image should return correct amount of data', done => {
    chai
      .request(`http://${process.env.host}:${process.env.port}`)
      .get(
        `${config.prefix}/?requestType=WADO&studyUID=1.3.6.1.4.1.14519.5.2.1.1706.4996.267501199180251031414136865313&seriesUID=1.3.6.1.4.1.14519.5.2.1.1706.4996.170872952012850866993878606126&objectUID=1.3.6.1.4.1.14519.5.2.1.1706.4996.101091068805920483719105146694`
      )
      .buffer()
      .parse(binaryParser)
      .end((err, res) => {
